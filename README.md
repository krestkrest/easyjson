# easyjson [![Build Status](https://github.com/krestkrest/easyjson/actions/workflows/easyjson.yml/badge.svg)](https://github.com/krestkrest/easyjson/actions/workflows/easyjson.yml) [![Go Report Card](https://goreportcard.com/badge/github.com/krestkrest/easyjson)](https://goreportcard.com/report/github.com/krestkrest/easyjson)
...
```sh
# for Go < 1.17
go get -u github.com/krestkrest/easyjson/...
```
#### or
```sh
# for Go >= 1.17
go get github.com/krestkrest/easyjson && go install github.com/krestkrest/easyjson/...@latest
```
### Run:
```sh
...
Please see the [GoDoc](https://godoc.org/github.com/krestkrest/easyjson)
...
listing](https://godoc.org/github.com/krestkrest/easyjson) for the full listing of
...
Please see the [GoDoc listing](https://godoc.org/github.com/krestkrest/easyjson/buffer)
